...
$experience = [ 
 ...
 'text' => 'Заключение договоров, проверка документов на подлинность, юридическое сопровождение сделок', 
    ],
    [
 'name' => 'Бухгалтер', 
 'dateBegin' => 'февраль 2019',
 'dateEnd' => 'Январь 2022',
 'text' => 'Ведение бух.учета предприятия, составление отчетов для налоговой', 
    ],
    [
 'name' => 'Менеджер', 
 'dateBegin' => 'Июнь 2001',
 'dateEnd' => 'Ноябрь 2018',
 'text' => 'обеспечение наличия продукции на складе, выполнения плана продаж, отчетность',
    ],
];
?>
<!DOCTYPE html>
        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            ...
            <h6 class="w3-text-teal">
                ...
                <?php echo $experience[$i]['dateBegin']; ?> - 
                <?php if ($i == 0): ?>
